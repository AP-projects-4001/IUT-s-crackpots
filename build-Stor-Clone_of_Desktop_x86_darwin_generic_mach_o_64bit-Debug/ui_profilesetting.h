...
public:
    ...
    QCheckBox *changePasswordcheckBox;
    ...
    void setupUi(QMainWindow *profileSetting)
    {
        ...
        changePasswordcheckBox = new QCheckBox(groupBox_2);
        changePasswordcheckBox->setObjectName(QString::fromUtf8("changePasswordcheckBox"));

        gridLayout_2->addWidget(changePasswordcheckBox, 0, 0, 1, 1);
        ...
        horizontalLayout_9->addWidget(genderComboBox);
    ...
    void retranslateUi(QMainWindow *profileSetting)
    {
        ...
        changePasswordcheckBox->setText(QCoreApplication::translate("profileSetting", "I want to  Change my password", nullptr));
        ...
        label_11->setText(QCoreApplication::translate("profileSetting", "Gender:", nullptr));
