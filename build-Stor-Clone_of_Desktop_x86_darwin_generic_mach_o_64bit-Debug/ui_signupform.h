...
public:
    ...
    void setupUi(QDialog *signUpForm)
    {
        ...
        genderComboBox = new QComboBox(signUpForm);
        genderComboBox->setObjectName(QString::fromUtf8("genderComboBox"));

        horizontalLayout_10->addWidget(genderComboBox);
    ...
    void retranslateUi(QDialog *signUpForm)
    {
        ...
        label_9->setText(QCoreApplication::translate("signUpForm", "Gender:", nullptr));
